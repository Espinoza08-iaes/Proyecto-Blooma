...
<p align="center">
  <strong>Ecosistema Progresivo de Salud Femenina y Acompañamiento Integral</strong><br>
  <em>10ª Edición Hackathon Nicaragua 2026 — "10 años, Siempre más allá"</em>
</p>
...
## 2. Los 4 Objetivos Clínicos Especializados

A diferencia de las herramientas convencionales de ciclo fijo, Blooma adapta su modelo predictivo a 4 necesidades de salud diferenciadas:
...
* **Credenciales de Demostración para Evaluadores:**
  ...
  * Modalidad de Acceso: Entrada libre en **Modo Privado Off-Grid** o mediante inicio de sesión.

---

## 4. Galería de Interfaz y Experiencia de Usuario (PWA)

<p align="center">
  <img src="entregables_hackathon/assets/02_dashboard_desktop_view.png" width="90%" alt="Vista Panorámica de Escritorio Blooma" />
  <br>
  <em>Vista de escritorio: Simulador fisiológico de estrógeno/progesterona y canalización directa MINSA 102.</em>
</p>

| Bitácora de Registro Diario | Triaje Clínico de Emergencia | Directorio de Casas Maternas | Ajustes y PIN de Seguridad |
| :---: | :---: | :---: | :---: |
| <img src="entregables_hackathon/assets/03_registro_diario_mobile.png" width="180" alt="Registro Diario" /> | <img src="entregables_hackathon/assets/08_embarazo_triaje_banner.png" width="180" alt="Triaje Obstétrico" /> | <img src="entregables_hackathon/assets/10_embarazo_directorio_casas_maternas.png" width="180" alt="Casas Maternas" /> | <img src="entregables_hackathon/assets/22_ajustes_objetivos_y_modo_discreto_mobile.png" width="180" alt="Seguridad y PIN" /> |
| Registro visual de estados de ánimo, flujo y temperatura. | Evaluación de signos de peligro según Norma Técnica Nº 011. | Listado geolocalizado departamental con llamada directa. | Modo discreto anti-estigma y bloqueo por PIN de 4 dígitos. |

---

## 5. Ficha Técnica Institucional — Hackathon Nicaragua 2026

| Parámetro Oficial | Detalle |
| :--- | :--- |
| **Nombre del Proyecto** | Blooma (Salud Femenina y Acompañamiento Integral) |
| **Equipo Representante** | **Git Push & Pray** |
| **Categoría** | Aficionado |
| **Temática Oficial** | Salud - AF (Atención Femenina) |
| **Institución Académica** | Universidad Nacional de Ingeniería (UNI) — Sede Managua |
| **Licencia de Código** | Código Abierto bajo Licencia MIT |

### Integrantes y Asignación por Disciplina

| Integrante | Rol Asignado | Disciplina Responsable |
| :--- | :--- | :--- |
| **ISAAC ANTONIO ESPINOZA SAENZ** | Desarrollador Principal | Arquitectura de Software & Frontend PWA |
| **GERMAN EMANUEL GONZALEZ ROSTRAN** | Desarrollador Backend | API REST, Base de Datos & Ciberseguridad |
| **ETHEL YASSIRYS SUAREZ ESPINOZA** | Diseñadora UI / UX | Identidad Visual, UI/UX & Accesibilidad WCAG |
| **MIGUEL ANGEL TORRES GUADAMUZ** | Estratega de Producto | Modelo de Negocio, Finanzas & Marketing |
| **KEVIN GAEL TORREZ URBINA** | Comunicador | Comunicación Estratégica, Pitch & Storytelling |

---

## 6. Arquitectura de Software y Seguridad Criptográfica

```mermaid
graph TD
    User["Usuaria / Gestante / Evaluador"] --> PWA["Frontend PWA (React 18 + Vite + TypeScript)"]
    
    subgraph CapaCliente ["Capa Cliente — Dispositivo y Almacenamiento Local-First"]
        PWA --> Router["Enrutamiento y 4 Objetivos Clínicos"]
        PWA --> UIState["Gestor de Estado Fisiológico"]
        UIState --> LocalDB[("IndexedDB / Dexie.js (Almacenamiento Local)")]
        PWA --> BLE["Web Bluetooth / Health Connect API"]
    end
    
    subgraph CapaSeguridad ["Capa de Red y Seguridad Criptográfica"]
        LocalDB -.->|"Sincronización Opcional Cifrada"| API["Backend Node.js + Express API"]
        API --> AuthGuard["Autenticación PBKDF2 210k + JWT Seguro"]
        AuthGuard --> CloudDB[("PostgreSQL / Supabase Row Level Security")]
    end
    
    subgraph CapaComunitaria ["Interconexión con Salud Pública"]
        PWA --> MINSA["Red Nacional de Casas Maternas MINSA (102)"]
    end
```
...
## 7. Dossier Oficial de Entregables (`entregables_hackathon/`)

La carpeta [entregables_hackathon/](entregables_hackathon/) contiene la documentación técnica, gráfica y estratégica clasificada por áreas de trabajo:

* **01_desarrollo/**
  * `01_README_TECNICO_Y_ENDPOINTS.md` — Arquitectura desacoplada, catálogo de endpoints REST y variables.
  * `02_DIAGRAMA_ER_3FN.md` — Diagrama Entidad-Relación normalizado en 3FN y diccionario de datos.
  * `03_DIAGRAMAS_UML.md` — Diagramas UML de Casos de Uso, Actividades y Clases.
  * `04_FLUJO_GIT_Y_CONVENCIONES.md` — Metodología GitFlow y Conventional Commits.
  * `05_SEGURIDAD_Y_DESPLIEGUE.md` — Políticas RLS, PBKDF2 (210k iteraciones) y verificación Vercel.
* **02_diseno_grafico/**
  * `logos/` — Logotipos vectoriales SVG (principal, horizontal, isotipo, monocromático).
  * `01_MANUAL_DE_IDENTIDAD.md` — ADN de marca, área de reserva y retícula de construcción.
  * `02_FICHA_TECNICA_COLOR_WCAG.md` — Códigos HEX, RGB, CMYK y matrices de contraste WCAG AA.
  * `03_SISTEMA_TIPOGRAFICO.md` — Jerarquía Outfit/Inter y escala tipográfica responsive.
  * `04_MOODBOARD_Y_VALORES.md` — Brief creativo, valores y arquetipos de marca.
  * `05_UX_WIREFRAMES_Y_MOCKUPS.md` — Arquitectura de información y especificación de interfaz.
* **03_marketing_y_negocios/**
  * `01_BUSINESS_MODEL_CANVAS.md` — Matriz de 9 bloques de modelo de negocio e impacto social.
  * `02_BUYER_PERSONAS_Y_EMPATIA.md` — Perfiles psicográficos y mapas de empatía.
  * `03_PLAN_BRANDING_Y_ARQUETIPOS.md` — Posicionamiento de marca (El Cuidador y El Sabio).
...
```
Proyecto-Blooma/
├── frontend/                  # Aplicación Cliente PWA (React 18, Vite, TypeScript, IndexedDB)
│   ├── src/
│   │   ├── components/        # Componentes UI (HeroDial, WearableSyncCard, ProfileSettingsDrawer)
│   │   ├── db/                # Clientes IndexedDB (Dexie) y Supabase
│   │   └── types/             # Definiciones de tipos TypeScript
│   └── public/                # Manifiesto PWA, iconos e imágenes estáticas
│
├── backend/                   # API REST y Microservicios (Node.js, Express, Criptografía OWASP)
│   ├── src/
│   │   ├── routes/            # Rutas de Autenticación, Salud y Directorio MINSA
│   │   ├── auth.js            # Middleware de Seguridad y Verificación de Tokens
│   │   └── index.js           # Punto de Entrada del Servidor
│   └── .env.example           # Plantilla de Variables de Entorno Segura
│
├── entregables_hackathon/     # Dossier Oficial de Entregables Hackathon 2026
│   ├── 01_desarrollo/         # Documentos Técnicos y Diagramas
│   ├── 02_diseno_grafico/     # Manual de Identidad, Logos SVG y Paletas WCAG
│   ├── 03_marketing_y_negocios/ # Canvas, Personas, Estrategia y Finanzas
│   ├── assets/                # Galería de 23 Capturas Reales de la Interfaz
│   ├── pdf/                   # 10 Documentos y Plantillas en PDF para Evaluación
│   └── README.md              # Portada y Mapa de Navegación del Dossier
│
...
```bash
git clone https://github.com/Espinoza08-iaes/Proyecto-Blooma.git
cd Proyecto-Blooma
```

### 2. Levantar el Frontend (PWA)
```bash
cd frontend
npm install
npm run dev
```
Disponible localmente en `http://localhost:5173`.
...
npm run dev
```
El servidor backend escuchará en `http://localhost:3000`.

---

## 10. Licencia

Este proyecto está bajo la Licencia MIT. Consulte el archivo correspondiente para mayor información.
