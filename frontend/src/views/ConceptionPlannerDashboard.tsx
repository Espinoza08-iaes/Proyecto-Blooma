  ...
  return (
    <div className="space-y-6 pb-20 animate-fade-in relative min-h-screen bg-gradient-to-b from-pink-50/70 via-rose-50/40 to-slate-50">
      ...
      <header className="flex items-center justify-between pt-2 px-2">
        ...
        >
          <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-pink-500 to-rose-500 text-white flex items-center justify-center text-xl shadow-md group-hover:scale-105 transition-all overflow-hidden border-2 border-white">
